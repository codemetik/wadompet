<div class="row">
	...
	<div class="card">
		<div class="card-header bg-nav">
			<h1 class="card-title text-bold float-left">Data Anggota Kelas X PPLG/RPL 2</h1>
			...
			<table id="example1" class="table table-sm table-bordered table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td><a href="?page=edit_set_member&id=<?= $data['user']; ?>" class="btn btn-white elevation-1" title="Edit Data"><i class="fas fa-edit text-orange"></i></a></td>
					</tr>
					<?php }
