        ...
        <div class="row">
            ...
            <div class="info-box callout callout-grey">
              ...
              <div class="info-box-content">
                <div class="direct-chat-msg">
                  <div class="direct-chat text-sm text-left">
                    <b class="text-danger">Anisa :</b> Selamat pagi guys! sehat
                  </div>  
                </div>  
                <div class="progress">
          ...
          <!-- /.col -->
          <div class="col-md-3 col-sm-6 col-12"><a href="" class="text-dark">
            <div class="info-box callout callout-grey">
              <span class="info-box-icon text-orange elevation-1"><i class="far fa-bell"></i></span>

              <div class="info-box-content">
                <span class="info-box-text">Hari ini linda berulang tahun</span>
          ...
          <!-- /.col -->
          <div class="col-md-3 col-sm-6 col-12"><a href="?page=riwayat_trx" class="text-dark">
            <div class="info-box callout callout-grey">
          ...
          <!-- /.col -->
          <div class="col-md-3 col-sm-6 col-12"><a href="?page=transfer" class="text-dark">
            <div class="info-box callout callout-grey">
