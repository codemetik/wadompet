...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 31 Jul 2023 pada 10.29
...
(43, 'administrator', 'ADMIN', 'admin', 'adminrpl', 'admin@gmail.com', '089643232261', 'Pemalang', '2008-02-12', 'Ds. Iser, Kec. Petarukan, Kab. Pemalang', '', 1);
...
--
ALTER TABLE `riwayat_topup`
  MODIFY `id_riwayat` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
ALTER TABLE `tiket_topup`
  MODIFY `id_tiket` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
